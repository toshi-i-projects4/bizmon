(function () {
  window.resultStep1Executed = true;
  ...
  saveStatus.textContent = "STEP1_EXTERNAL_V2起動：外部JavaScriptは実行されました。localStorage確認中...";
  ...
  try {
    ...
    saveStatus.textContent =
      "STEP1_EXTERNAL_V2_OK：外部JavaScriptで結果表示に成功しました。
" +
...
" +
    ...
    saveStatus.textContent =
      "STEP1_EXTERNAL_V2_ERROR：外部JavaScriptは実行されましたが、処理中にエラーが発生しました。
" +
